...
class MeshTopo(Topo):
    ...
    def __init__(self, n=3):
        ...
        self.addLink( s1, s2, bw =10, delay='20' )
        self.addLink( s1, s3, bw=10, delay='5' )
        self.addLink( s1, s4, bw=10, delay='10' )
        self.addLink( s2, s4, bw=10, delay= '10' )
        self.addLink( s3, s4, bw=10, delay='15' )
